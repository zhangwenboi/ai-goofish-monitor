const enUSExtra = {
  tasks: {
    ...
    form: {
      ...
      monitorMode: 'Monitor (New/Price Drop Only)',
      crawlInterval: 'Min Crawl Interval',
      crawlIntervalPlaceholder: 'Leave empty for no limit (minutes)',
      crawlIntervalHint: 'If set, the task will be skipped when the interval since last run is less than this value.',
  ...
  notifyPanel: {
    ...
    dingtalk: {
      title: 'DingTalk Bot',
      description: 'Supports HMAC-SHA256 signature verification. Webhook URL and Secret are sensitive fields.',
      configuredHint: 'Webhook URL is already stored.',
      secretLabel: 'Signing Secret',
      secretPlaceholder: 'Secret starting with SEC (optional)',
      secretHint: 'Optional. Enables HMAC-SHA256 signature verification when configured.',
    },
    telegram: {
